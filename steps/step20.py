...
class Variable:
    ...
    def __add__(self, other):
        assert isinstance(other, Variable), f"Variable can on be added by Variable, got {type(other)}"
        return add(self, other)
    
    def __mul__(self, other):
        assert isinstance(other, Variable), f"Variable can on be multiplied by Variable, got {type(other)}"
